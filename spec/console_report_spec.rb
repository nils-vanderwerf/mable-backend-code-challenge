...
RSpec.describe ConsoleReport do
  describe ".print" do
    ...
    context "for an unsuccessful transfer due to an invalid amount" do
      let(:invalid_amount_transfer) { TransferResult.new(transfer: transfer, success: false, reason: TransferResult::INVALID_AMOUNT) }
      let(:invalid_amount_result) { [invalid_amount_transfer] }
      it "displays an invalid amount message" do
